 ...
 * @method \Intervention\Image\Image contain(integer $width, integer $height, boolean $resizeCanvas = false, mixed $fill = null)                                          Resize the image within the width and height, keeping the aspect ratio. The canvas can be optionally resized to fit the width and height exactly. If there are gaps a fill color can be optionally applied, if true is passed then a color average will be calculated for the fill.
